      ...
      <div className="columns">
        <div className="column fadeLeftMini">
          ...
          <p>
            ...
            effort to hire the best specialists with exceptional copywriting
            skills and experience producing company copy for particular
            verticals. Why? Said that the greatest website copywriters create
            the most effective website copy.
          </p>
        </div>
        <div className="column fadeRightMini">
          ...
          <p>
            ...
            require technical writing, legal copywriting, or something else, we
            can help. Furthermore, our team will match your writing job with the
            ideal writer based on your specific goals and background.
          </p>
          <h5>Google-friendly SEO content writing</h5>
          <p>
            Search engine optimization is key to getting your text in front of a
          ...
          <button
            ...
            onClick={(event) => (window.location.href = '/ContentPriceList')}
          >
